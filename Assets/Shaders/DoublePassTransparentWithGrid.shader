Shader "Custom/DoublePassTransparentWithGrid"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                // Ensure the grid lines are drawn on top, while respecting the texture's transparency
                return gridLineColor + texColor * (1 - gridLineColor.a);
            }
            ENDCG
        }
    }
    ...
    SubShader
    {
        // Second pass: render back faces with transparency settings
